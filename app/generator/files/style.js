...
const styleFiles = function styleFiles() {
    ...
    if (this.cssOption === 'stylus') {
        templates.push(
            { from: 'src/static/styles/main.styl', to: 'src/_styles/main.styl' },
            { from: 'src/static/styles/main-styleguide.styl', to: 'src/_styles/main-styleguide.styl' },
            { from: 'src/static/styles/helpers/_functions.styl', to: 'src/_styles/helpers/_functions.styl' },
            { from: 'src/static/styles/helpers/_helpers.styl', to: 'src/_styles/helpers/_helpers.styl' },
            { from: 'src/static/styles/helpers/_mixins.styl', to: 'src/_styles/helpers/_mixins.styl' },
            { from: 'src/static/styles/vars/_checkbox.styl', to: 'src/_styles/vars/_checkbox.styl' },
            { from: 'src/static/styles/vars/_colors.styl', to: 'src/_styles/vars/_colors.styl' },
            { from: 'src/static/styles/vars/_easing.styl', to: 'src/_styles/vars/_easing.styl' },
            { from: 'src/static/styles/vars/_fonts.styl', to: 'src/_styles/vars/_fonts.styl' },
            { from: 'src/static/styles/vars/_global.styl', to: 'src/_styles/vars/_global.styl' },
            { from: 'src/static/styles/vars/_input.styl', to: 'src/_styles/vars/_input.styl' },
            { from: 'src/static/styles/vars/_layout.styl', to: 'src/_styles/vars/_layout.styl' },
            { from: 'src/static/styles/vars/_radio.styl', to: 'src/_styles/vars/_radio.styl' },
            { from: 'src/static/styles/vars/_select.styl', to: 'src/_styles/vars/_select.styl' },
            { from: 'src/static/styles/vars/_textarea.styl', to: 'src/_styles/vars/_textarea.styl' },
            { from: 'src/static/styles/vars/_index.styl', to: 'src/_styles/vars/_index.styl' },
            { from: 'src/static/styles/base/_typography.styl', to: 'src/_styles/base/_typography.styl' },
            { from: 'src/static/styles/layout/_base.styl', to: 'src/_styles/layout/_base.styl' },
            { from: 'src/static/styles/vendors/badger-accordion/custom.styl', to: 'src/_styles/vendors/badger-accordion/custom.styl' },
            ...
            { from: 'src/shared/_styles/choices-select/choices-select.styl', to: 'src/_modules/choices-select/choices-select.styl' },
            ...
            { from: 'src/shared/_styles/toggler/toggler.styl', to: 'src/_modules/toggler/toggler.styl' },
            { from: 'src/shared/_styles/accordion/accordion.styl', to: 'src/_modules/accordion/accordion.styl' },
            { from: 'src/shared/_styles/upload-btn/upload-btn.styl', to: 'src/_modules/upload-btn/upload-btn.styl' },
            { from: 'src/shared/_styles/modal/modal.styl', to: 'src/_modules/modal/modal.styl' },
            { from: 'src/shared/_styles/overlay/overlay.styl', to: 'src/_modules/overlay/overlay.styl' },
            { from: 'src/shared/_styles/scroll-to/scroll-to.styl', to: 'src/_modules/scroll-to/scroll-to.styl' },
            { from: 'src/shared/_styles/scroll-top/scroll-top.styl', to: 'src/_modules/scroll-top/scroll-top.styl' },
            { from: 'src/static/styles/components/_avatar.styl', to: 'src/_styles/components/_avatar.styl' },
            { from: 'src/static/styles/components/_badge.styl', to: 'src/_styles/components/_badge.styl' },
            { from: 'src/static/styles/components/_breadcrumbs.styl', to: 'src/_styles/components/_breadcrumbs.styl' },
            { from: 'src/static/styles/components/_button.styl', to: 'src/_styles/components/_button.styl' },
            { from: 'src/static/styles/components/_checkbox.styl', to: 'src/_styles/components/_checkbox.styl' },
            { from: 'src/static/styles/components/_dropdown.styl', to: 'src/_styles/components/_dropdown.styl' },
            { from: 'src/static/styles/components/_horizontal-rule.styl', to: 'src/_styles/components/_horizontal-rule.styl' },
            { from: 'src/static/styles/components/_icon.styl', to: 'src/_styles/components/_icon.styl' },
            { from: 'src/static/styles/components/_icons.styl', to: 'src/_styles/components/_icons.styl' },
            { from: 'src/static/styles/components/_input.styl', to: 'src/_styles/components/_input.styl' },
            { from: 'src/static/styles/components/_keyframes.styl', to: 'src/_styles/components/_keyframes.styl' },
            { from: 'src/static/styles/components/_link.styl', to: 'src/_styles/components/_link.styl' },
            { from: 'src/static/styles/components/_list.styl', to: 'src/_styles/components/_list.styl' },
            { from: 'src/static/styles/components/_radio.styl', to: 'src/_styles/components/_radio.styl' },
            { from: 'src/static/styles/components/_search.styl', to: 'src/_styles/components/_search.styl' },
            { from: 'src/static/styles/components/_select.styl', to: 'src/_styles/components/_select.styl' },
            { from: 'src/static/styles/components/_socials.styl', to: 'src/_styles/components/_socials.styl' },
            { from: 'src/static/styles/components/_spinner.styl', to: 'src/_styles/components/_spinner.styl' },
            { from: 'src/static/styles/components/_subscribe-input.styl', to: 'src/_styles/components/_subscribe-input.styl' },
            { from: 'src/static/styles/components/_textarea.styl', to: 'src/_styles/components/_textarea.styl' },
            { from: 'src/static/styles/components/_form.styl', to: 'src/_styles/components/_form.styl' },
            { from: 'src/static/styles/pages/home/_index.styl', to: 'src/_styles/pages/home/_index.styl' }
        );
    }
